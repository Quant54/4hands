...
///НЕВЕДАНАЯ ДО СИЛЕ МАГИЯ
add_action( 'init', 'tp_dk_pdf_init', 11 );
function tp_dk_pdf_init() {
...
add_filter('excerpt_more', function($more) {
    return '... <span style="color: #DD567B;"> [Читать дальше &raquo;] 	 </span>';
});
function b5f_on_load_script()
{
	...
	if ( is_page( 'manicure' ) || is_page( 'pedicure' ) || is_page( 'coating' ) || is_page( 'formen' ) || is_page( 'kids' ) ) {
		?>
<!--		<script src="/wp-content/themes/cinderella/js/choose_city.js"></script>-->
		<script src="/wp-content/themes/cinderella/js/services.js"></script>
	...
	if ( is_page( 'index' ) ) {
		?>
<!--		<script src="/wp-content/themes/cinderella/js/choose_city.js"></script>-->
		<script src="/wp-content/themes/cinderella/js/main.js"></script>
<!--		<script src="/wp-content/themes/cinderella/js/map.js"></script>-->
		<?php
	}

	if ( is_page( '3425' ) || is_page( 'index' )  ) {
		?>
		<script src="/wp-content/themes/cinderella/js/choose_city_studios.js"></script>
		<script src="/wp-content/themes/cinderella/js/jquery.spincrement.js"></script>
		<script src="/wp-content/themes/cinderella/js/studios.js"></script>
<!--		<script src="/wp-content/themes/cinderella/js/map.js"></script>-->
		<?php
	}

	if ( is_page( 'tseny' ) || is_page( 'prices' ) ) {
		?>
	
		<script src="/wp-content/themes/cinderella/js/prices.js"></script>
