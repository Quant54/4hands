...
jQuery(document).ready(function () {
    ...
    jQuery(".services-title__text").fadeIn(3000);
    //jQuery(".services-title__container").find(".elementor-heading-title").css({"border": "2px red solid"});
    jQuery(".services-title__container").find(".elementor-heading-title").hide().fadeIn(300);
    //jQuery(".services-title__container").find(".elementor-heading-title").fadeIn(3000);
